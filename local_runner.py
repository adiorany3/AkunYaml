...
APP_VERSION = "4.3-android-marketplace-live"
...
CORE_FILES = ("generate_yaml.py", "sumberyaml_core.py", "security_policy.py", "android_marketplace_policy.py", "feed_guard.py", "requirements.txt", "openclash_target.py")
OUTPUT_YAMLS = (
    "openclash_auto.yaml",
...
def apply_security(path: Path, profile: str, workdir: Path, interval: int, dns_mode: str) -> bool:
    ...
    elif is_android and marketplace_rules:
        security_rules.extend(marketplace_rules)
