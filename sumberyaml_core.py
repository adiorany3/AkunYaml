    ...
    config: dict[str, Any] = {
        ...
        **_mihomo_keep_alive_config(),
        ...
        "dns": {
            ...
            "cache-algorithm": "arc",
            "respect-rules": True,
            "default-nameserver": ["https://1.1.1.1/dns-query", "https://9.9.9.9/dns-query"],
            ...
            "fallback": ["tls://9.9.9.9", "tls://94.140.14.14", "https://1.1.1.1/dns-query", "https://dns.google/dns-query"],
